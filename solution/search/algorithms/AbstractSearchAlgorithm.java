...
public abstract class AbstractSearchAlgorithm {
	...
	public void verboseSearch() {
		...
		if (this.goalFound()) {
			...
			System.out.println(String.format("Arrived at %s for cost %.2f at depth %d", goal, finalCost, finalDepth));
